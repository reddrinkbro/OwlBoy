...
public:
	...
	Image* addPngImage(string strKey);
	...
	void DrawPng(Graphics* graphics, Image * tempimage, int x, int y, int currentX, int currentY, int width, int height, int frameX, int frameY);
	void DrawPng(Graphics* graphics, Image* tempimage, int x, int y);
	void DrawPng(Graphics* graphics, Image* tempimage, int x, int y,int width, int height);
	imageManager() {}
	~imageManager() {}
};
